...
| `TRACE-017` | `Q-003` | `DEC-003` | Production hardening | `AC-042` / `TEST-042` | `P1-M3` | `HARDEN` | `HARDEN-1A` | `HARDEN-1A.1`~`HARDEN-1A.5` | `HARDEN-1A.1` parser-level schema validation and `HARDEN-1A.2` configurable endpoint-group rate limiting landed; integration/load and deployment handoff work remains planned. |
