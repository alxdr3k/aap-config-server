...
| `TRACE-015` |  |  | `FR-10` | `AC-040` / `TEST-040` | `P1-M3` | `EXT` | `EXT-1C` | `EXT-1C.1`~`EXT-1C.4` | `EXT-1C.1` defaults source parsing, `EXT-1C.2` internal merge semantics, and `EXT-1C.3` public `inherit` query behavior landed; admin write preservation regression remains leaf-planned. |
