...
| `P1-M3` | Console integration extensions and production hardening. |  | `in_progress` | `AC-040`~`AC-042` | `docs/01_PRD.md`, `DEC-003` | `EXT-1A.1`~`EXT-1A.3` landed; next EXT leaf needs ready promotion review. |
...
| `EXT` | Watch, history, revert, inheritance, batch, webhook, metrics, and HTTP response extensions. | none | `in_progress` | `EXT-1A` watch slices landed. Later EXT slices remain planned until ready promotion review. |
