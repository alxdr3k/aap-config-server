...
> 프로젝트 구조, 패키지 설계, 의존성 주입, 에러 처리 등 **Go 설계 원칙**은 [HLD 섹션 11](./02_HLD.md#11-go-설계-원칙)을 참조한다.
...
> 의존성 주입, 에러 타입, 프로젝트 구조 등 구체적인 Go 설계 패턴은 [HLD 섹션 11](./02_HLD.md#11-go-설계-원칙)을 참조한다.
