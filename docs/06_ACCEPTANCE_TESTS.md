...
| `TEST-030` | Config Agent tests | `internal/agent/*_test.go`; future k8s/e2e tests | `AC-030` bootstrap, leader election, fetch loop, and rendering coverage; full rollout future |
