...
| `TEST-041` | Operational extension tests | `internal/handler/handler_test.go`; future batch/metrics/webhook tests | `AC-041` ETag/`If-None-Match` and gzip coverage landed; remaining operational extensions planned |
