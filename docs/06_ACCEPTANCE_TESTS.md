...
| `TEST-030` | Config Agent tests | `internal/agent/*_test.go`; future k8s/e2e tests | `AC-030` bootstrap, leader election, fetch loop, rendering, ConfigMap/Secret apply, and rollout patch coverage; full orchestration future |
