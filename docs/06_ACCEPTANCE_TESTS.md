...
| `TEST-041` | Operational extension tests | `internal/handler/handler_test.go`; future gzip/batch/metrics/webhook tests | `AC-041` ETag/`If-None-Match` coverage landed; remaining operational extensions planned |
