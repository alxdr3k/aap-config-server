...
| `TEST-040` | Console extension tests | `internal/store/store_test.go`, `internal/handler/handler_test.go`; future env watch/history/revert/inheritance tests | `AC-040` store version wait primitive and config watch endpoint landed; env watch/history/revert/inheritance tests remain future |
