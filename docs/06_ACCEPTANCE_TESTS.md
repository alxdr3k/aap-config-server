...
| `TEST-041` | Operational extension tests | `internal/handler/handler_test.go`; future metrics/webhook tests | `AC-041` ETag/`If-None-Match`, gzip, and batch read coverage landed; remaining operational extensions planned |
