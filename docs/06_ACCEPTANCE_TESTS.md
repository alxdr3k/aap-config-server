...
| `TEST-040` | Console extension tests | `internal/store/store_test.go`; future watch/history/revert/inheritance tests | `AC-040` store version wait primitive landed; endpoint and history/revert/inheritance tests remain future |
