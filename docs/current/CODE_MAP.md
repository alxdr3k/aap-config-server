...
| `internal/handler/` | HTTP routing, request decoding, API key auth, JSON response/error envelope, config/env watch long polling, versioned reads, and history API responses. |
