...
### 1. Optimistic Concurrency (version 기반) — 미채택
...
**서비스별 Mutex + Pull-rebase 채택**.

### 근거: Git 충돌은 구조적으로 불가능하다
...
- [PRD FR-4: 설정/시크릿 일괄 변경 Admin API](../01_PRD.md)
